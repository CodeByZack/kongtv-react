...
import { Avatar, Drawer, makeStyles, Typography, List,ListItem,ListItemText,ListItemIcon } from '@material-ui/core';
  ...
  return (
    ...
    >
      <div className={styles.drawerTop} >
        ...
        <Typography component='p' className={styles.drawerAppName} >风影院 V1.0.0</Typography>
      </div>
